      ...
      if (tuition === null) {
        ...
        if (
          ...
          if (siid === null) {
            ...
            console.log("mergeInvoiceId");
            const existMergeInvoice = mergeInvoices.find(
              (minv) => minv.id === mergeInvoiceId
            );

            console.log("merge invoice");
            console.log(existMergeInvoice);
