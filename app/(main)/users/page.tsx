...
export default function UserList() {
  ...
  const [verifiedUsersColumns, setVerifiedUsersColumns] =
    useState(initialColumns);
  const [unverifiedUsersColumns, setUnverifiedUsersColumns] =
    useState(initialColumns);
