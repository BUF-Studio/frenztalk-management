...
export default function AnalyticsDashboard() {
  ...
  const { totalHours, trialHours, endHours } = useTuitions();
  const { totalReceiveRate } = useInvoices();
  const { totalPaymentRate } = usePayments();
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1 p-4 md:p-6 space-y-6">
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          ...
          {/* Total hours of lesson */}
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium">Total Hour Registered</CardTitle>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium">Total Hour Complete</CardTitle>
              <BarChart3 className="w-4 h-4 text-muted-foreground" />
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{endHours.toString()}</div>
              {/* <p className="text-xs text-muted-foreground">
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between pb-2 space-y-0">
              <CardTitle className="text-sm font-medium">Total Trial Hour</CardTitle>
          ...
          <TabsContent value="overview" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Daily page views for the last week
                </CardDescription>
              </CardHeader>
          ...
          <TabsContent value="pageviews" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Detailed view of page visits over time
                </CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <ResponsiveContainer width="100%" height={350}>
          ...
          <TabsContent value="users" className="space-y-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  New vs Active Users over the past month
                </CardDescription>
              </CardHeader>
              <CardContent className="pl-2">
                <ResponsiveContainer width="100%" height={350}>
